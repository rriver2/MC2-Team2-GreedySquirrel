                            ...
                            VStack(spacing: 10) {
                                ...
                                HStack(spacing: 6) {
                                    ForEach(editorMainContent.contentEquipments.indices, id: \.self) { equipmentIndex in
                                        ...
                                        NavigationLink {
                                            DictionaryContentView(equipmentCategory: "ㅗㅑㅗ", jsonFileName: self.viewModel.editorMainCollection.editorMainContents[contentsIndex].contentEquipments[equipmentIndex].paintingImageName)
                                        } label: {
